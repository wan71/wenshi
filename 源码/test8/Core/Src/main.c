...
extern driver_uart_2 uart_2;
extern driver_uart_3 uart_3;
//串口结构体初始化
...
/*
3个出口接受中断初始化DMA,并且开启空闲中断，空闲中断需要规定齐内容的最大值receiveData_uart1
*/
...
//	HAL_UARTEx_ReceiveToIdle_DMA(&huart2, (uint8_t *)&uart_2.aRxBuffer, 2); 
//	
